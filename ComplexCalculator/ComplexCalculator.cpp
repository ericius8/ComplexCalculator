...
// ComplexCalculator.cpp: определяет поведение классов для приложения.
//
...
// Создание CComplexCalculatorApp
...
// Единственный объект CComplexCalculatorApp

CComplexCalculatorApp theApp;


// Инициализация CComplexCalculatorApp
